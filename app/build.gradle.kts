...
// Credenciales de firma cargadas desde keystore.properties (archivo NO versionado).
...
android {
    ...
    buildTypes {
        release {
            ...
            // Aplica la firma release solo si hay keystore.properties; si no, no rompe la config.
            if (keystorePropertiesFile.exists()) {
